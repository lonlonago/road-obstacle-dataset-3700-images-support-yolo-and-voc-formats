# Road Obstacle Dataset 3700 images support yolo and voc formats.

# Body

Road Obstacles Dataset, 3700 images, supports yolo and voc formats, including road obstructions, cone barrels, etc. The images are clear and labeled in detail, suitable for target detection, image segmentation, algorithm testing.
...
Signboards # Road barrier signs
Rockfall # Falling rocks
Tire # Road tire
SpeedBump # Speed bump
ImpactAttenuator # Impact absorber
Pothole # Road pothole

Barricade # Iron Horse Fence
Traffic_Delineator_Post # Traffic Delineator Post
